...
from wanderer.wanderer import get_map_acls
...
class WandererManagedMapAdminForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if not self.instance.pk:
            ...
            if self.data.get('wanderer_url') and self.data.get('map_slug') and self.data.get('map_api_key'):
                try:
                    acls = get_map_acls(
